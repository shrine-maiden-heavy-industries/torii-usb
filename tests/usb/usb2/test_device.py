...
from sol.gateware.test.usb2           import USBDeviceTest
from sol.gateware.usb.usb2            import USBPacketID
from sol.gateware.usb.usb2.descriptor import DeviceDescriptorCollection
